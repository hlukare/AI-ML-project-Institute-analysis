...
export default function DataTable({
    ...
    return (
      <div className="relative" ref={dropdownRef}>
        <button
          ...
          className="w-48 bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 rounded-lg px-4 py-2 text-left focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-150 ease-in-out text-sm font-medium text-gray-700 dark:text-gray-300"
        >
  ...
  return data ? (
    <div className="w-full max-w-[90%] mx-auto p-4 space-y-4 bg-white dark:bg-gray-800 shadow-lg rounded-lg">
